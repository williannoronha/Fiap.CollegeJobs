...
using ExamplePWA.Services;
using ExamplePWA.Store;
using Lib.Net.Http.WebPush;

namespace ExamplePWA.Controllers
{
    public class HomeController : Controller
    {
        ...
        public JsonResult GetPostByTitle(string title)
        {
            var post = _blogService.GetPostByTitle(title);
