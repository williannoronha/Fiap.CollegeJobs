...
namespace Fiap_CollegeJobsML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"F:\Project\source\repos\Fiap.CollegeJobs\src\ExercicioMLDotNet\Data\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\noronha\AppData\Local\Temp\MLVSTools\Fiap.CollegeJobsML\Fiap.CollegeJobsML.Model\MLModel.zip";
